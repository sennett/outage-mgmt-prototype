...
const testScheduler = new TestScheduler((recevied, expected) => {
...
describe('client-with-outage-stream', () => {
  ...
  it.todo('does not flat if hasOutage for 29 continuous seconds')
  it.todo('flags if hasOutage for 30 continuous seconds')
  it.todo('does not flag if !hasOutage for 5 continuous minutes')
})
